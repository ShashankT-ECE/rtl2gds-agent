module fsm_traffic_light (
    ...
    always @(*) begin
        ...
        next_state = state;
        // Note: counter update is combinatorial here, but this block
        // describes next state logic based on current counter value.
        // We'll handle counter update in a separate sequential block.
        case (state)
            RED: begin
