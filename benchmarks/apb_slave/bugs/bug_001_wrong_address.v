// Bug injection: address decode changed from PADDR[3:2] to PADDR[4:3].
// This causes the wrong register to be selected for a given APB address,
// corrupting all read/write operations.
...
module apb_slave (
    ...
    // Address decode — bug: uses bits [4:3] instead of [3:2]
    wire [1:0] addr_sel;
    assign addr_sel = PADDR[4:3];
    ...
    // PSLVERR: asserted only during a valid transfer to an invalid address
